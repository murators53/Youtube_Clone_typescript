...
export default function Navbar () {
    ...
    return (
        <div className=" overflow-y-scroll overflow-x-hidden flex-shrink-0 flex justify-between  items-center px-[16px] h-14 bg-[#0f0f0f] opacity-95 sticky top-0 z-40">
            ...
            <div  className='flex  items-center justify-between flex-row '>
                <form className='' onSubmit={e => {
                    ...
                    <div className='flex bg-[#0f0f0f]  border-[1px] border-[#2e2e2e] group items-center h-10 px-4 pr-0 rounded-l-full focus-within:border-[1px] focus-within:border-blue-500 focus-within:border-solid	'>
                        ...
                        <button className='h-10 w-16 flex items-center justify-center bg-zinc-800 rounded-r-full'>
                            <IoSearchOutline className='text-xl w-[1.8rem]' />
                        </button>
